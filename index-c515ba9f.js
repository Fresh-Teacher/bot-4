...
const u = async t => {
    ...
    a.innerHTML += l(!1, r.get("prompt")), c.reset();
    const o = h();
    a.innerHTML += l(!0, " ", o), a.scrollTop = a.scrollHeight;
    const s = document.getElementById(o);
    s && m(s);
    const e = await fetch("https://chat-gpt-clone-ann-glitch.vercel.app", {
        method: "POST",
        headers: {
    ...
    if (clearInterval(d), s.innerHTML = " ", e.ok) {
        ...
        s.innerHTML = "Something went wrong...", alert(n)
    }
};
